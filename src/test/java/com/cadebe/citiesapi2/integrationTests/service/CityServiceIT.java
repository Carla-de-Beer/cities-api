package com.cadebe.citiesapi2.integrationTests.service;
...
import com.cadebe.citiesapi2.service.CityService;
...
class CityServiceIT {
    ...
    void createNewCity() {
        String name = "new1";
        List<CityDTO> categoriesList1 = cityService.findAll();
        ...
        List<CityDTO> categoriesList2 = cityService.findAll();
