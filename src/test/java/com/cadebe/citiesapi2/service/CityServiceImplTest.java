...
class CityServiceImplTest {
    ...
    void findByName() {
        when(cityRepository.findByName(anyString())).thenReturn(Collections.singletonList(city1));
    ...
    void findByCountryCode() {
        when(cityRepository.findByCountryCode(anyString())).thenReturn(Arrays.asList(city1, city2));
        ...
        verify(cityRepository, times(1)).findByCountryCode(anyString());
        verifyNoMoreInteractions(cityRepository);
    }
    ...
    void save() {
        ...
        CityDTO savedVendorDTO = cityService.saveNewCity(cityDTO);
    ...
    void update() {
        ...
        CityDTO savedVendorDTO = cityService.update(UUID.fromString(ID_1), cityDTO);
